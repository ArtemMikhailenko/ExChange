...
import CryptoSelector from '../../components/deposit/CryptoSelector/CryptoSelector';
import NetworkSelector from '../../components/deposit/NetworkSelector/NetworkSelector';
import DepositDetails from '../../components/deposit/DepositDetails/DepositDetails';
import DepositHistory from '../../components/deposit/DepositHistory/DepositHistory';
import FAQSection from '../../components/deposit/FAQSection/FAQSection';
import DepositHeader from '../../components/deposit/DepositHeader/DepositHeader';
    ...
    <div className={theme === 'dark' ? styles.containerDark : styles.containerLight}>
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.mainContent}>
          {/* Main deposit form section */}
          <div className={styles.depositFormSection}>
            <div className={theme === 'dark' ? styles.formBoxDark : styles.formBoxLight}>
              ...
              <div className={`${styles.stepContainer} ${currentStep < 3 ? styles.disabledStep : ''}`}>
                <div className={styles.stepHeader}>
                  ...
                  <h2 className={styles.stepTitle}>{t('depositDetails')}</h2>
                </div>
                {currentStep >= 3 && <DepositDetails crypto={selectedCrypto} network={selectedNetwork} />}
              </div>
            </div>
